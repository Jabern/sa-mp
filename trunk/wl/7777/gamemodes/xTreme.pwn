...
new Menu_Vehicle[MAX_PLAYERS];
new Menu_Vehicle_Count[MAX_PLAYERS];
...
#define SendFormatMessageToAll(%1,%2,%3)	do{new sendfstring[MAX_STRING];format(sendfstring,MAX_STRING,(%2),%3);SendClientMessageToAll((%2),sendfstring);}while(FALSE)
...
/*	
new Float:FarmRandomSpawn[5][3] = {  //farm dm
	{ 1104.637, -358.7339, 73.9922 },
	{ 1306.1136, -783.5058, 92.0313 },
	{ 1103.8358, -299.1019, 73.985 },
	{ 1107.2117, -313.5557, 73.9922 },
	{ 1011.6588, -365.5457, 73.9922 }
};
new Float:DMRandomSpawns4[3][3] = { //SniperDM
	{2718.2190,2773.4170,77.3594},
	{2633.0801,2829.2290,122.9219},
	{2593.2629,2638.4695,114.0313}
};
new Float:DMRandomSpawns2[4][3] = { //ROCKETDM
	{-651.1365,2145.7837,75.5681},
	{-651.4705,2102.4055,75.5749},
	{-781.1786,2140.5537,75.5975},
	{-781.2332,2097.1089,75.6158}
};
new Float:DMRandomSpawns5[2][3] = { //KANTANADM
	{1590.6189,2393.2646,22.8204},
	{1626.6914,2389.0703,22.8204}
};
new Float:DMRandomSpawns[4][3] = { //DILDODM
	{1948.5366,2378.2458,23.8516},
	{2003.3873,2378.4185,23.8516},
	{2002.5066,2336.8433,23.8516},
	{1946.3746,2337.8730,23.8516}
};
new Float:DMRandomSpawns8[21][3] = { //TANKDM
	{-1113.3171,1066.1790,1342.7313},
	{-1112.9833,1071.3523,1342.6761},
	{-1113.8085,1076.3944,1342.3671},
	{-1114.5342,1082.6567,1341.9312},
	{-1113.6975,1088.6729,1341.8438},
	{-1113.0833,1094.0702,1341.8438},
	{-1116.4938,1053.3774,1342.9241},
	{-1115.6022,1046.1168,1342.8369},
	{-1116.2128,1040.0081,1343.0017},
	{-1115.9847,1033.2756,1342.9965},
	{-986.9406,1068.9661,1343.1383},
	{-986.0907,1074.9497,1343.4484},
	{-985.2386,1081.1219,1343.4095},
	{-984.4334,1087.1693,1343.4426},
	{-985.4276,1094.1631,1343.1558},
	{-987.4882,1058.3990,1343.0410},
	{-988.6868,1053.0062,1343.0569},
	{-987.9200,1048.9106,1342.9324},
	{-988.2421,1044.9828,1342.6597},
	{-988.5836,1039.4027,1342.1312},
	{-988.9286,1033.9396,1341.8610}
};
new Float:TownRandomSpawn[9][3] = { //TOWNDM
	{ 1481.7828, 336.7824, 20.002 },
	{ 1452.3782, 398.3139, 20.002 },
	{ 1436.559, 359.5114, 20.002 },
	{ 1399.5595, 335.9618, 20.002 },
	{ 1359.3127, 358.4674, 28.752 },
	{ 1387.3371, 415.4441, 29.4158 },
	{ 1390.1749, 430.1712, 20.9158 },
	{ 1391.0355, 375.8234, 20.9158 },
	{ 1427.8111, 394.9967, 20.9158 }
};
new Float:DMRandomSpawns7[6][3] = { //TENNISDM
	{1163.608643, 1237.598145, 12.570309},
	{1104.532471, 1239.572510, 12.070313},
	{1130.723267, 1273.784912, 12.070313},
	{1108.735962, 1300.366455, 13.320314},
	{1158.842773, 1327.683960, 13.812516},
	{1113.552490, 1340.046265, 12.320313}
};
new Float:DMRandomSpawns6[2][3] = { //AK47 DM
	{2836.4141,-2407.7808,36.0648},
	{2836.6094,-2487.6553,36.0648}
};
new Float:DMRandomSpawns3[2][3] = { //SMG DM
...
new spawns[][espawn] = {
	//{409.2281,2573.1426,16.3672, 0, ">> 出生在 /aa 大型特技场,输入 /che /car /feiji 召唤交通工具"},//Syntax: {x, y, z, interior, message}
	...
	{-2261.1379,2290.6130,4.8202, 0, ">> 出生在 /navy 大型特技场,输入 /che /car /feiji 召唤交通工具"},
...
/*public SetPlayerDMSpawn4(playerid){
	...
	SetPlayerPos(playerid, DMRandomSpawns4[rand][0], DMRandomSpawns4[rand][1], DMRandomSpawns4[rand][2]); // Warp the player
	DynUpdateStart(playerid); // Avoid falling through object's
	return 1;}
public SetPlayerDMSpawn2(playerid){
	new rand = random(sizeof(DMRandomSpawns2));
	SetPlayerPos(playerid, DMRandomSpawns2[rand][0], DMRandomSpawns2[rand][1], DMRandomSpawns2[rand][2]); // Warp the player
	DynUpdateStart(playerid); // Avoid falling through object's
	return 1;}
public SetPlayerDMSpawn5(playerid){
	new rand = random(sizeof(DMRandomSpawns5));
	SetPlayerPos(playerid, DMRandomSpawns5[rand][0], DMRandomSpawns5[rand][1], DMRandomSpawns5[rand][2]); // Warp the player
	DynUpdateStart(playerid); // Avoid falling through object's
	return 1;}
public SetPlayerDMSpawn(playerid){
	new rand = random(sizeof(DMRandomSpawns));
	SetPlayerPos(playerid, DMRandomSpawns[rand][0], DMRandomSpawns[rand][1], DMRandomSpawns[rand][2]); // Warp the player
	DynUpdateStart(playerid); // Avoid falling through object's
	return 1;}
public SetPlayerDMSpawn8(playerid){
	new rand = random(sizeof(DMRandomSpawns8));
	DynUpdateStart(playerid); // Avoid falling through object's
	SetPlayerPos(playerid, DMRandomSpawns8[rand][0], DMRandomSpawns8[rand][1], DMRandomSpawns8[rand][2]); // Warp the player
	return 1;}
public SetPlayerDMSpawn7(playerid){
	new rand = random(sizeof(DMRandomSpawns7));
	SetPlayerPos(playerid, DMRandomSpawns7[rand][0], DMRandomSpawns7[rand][1], DMRandomSpawns7[rand][2]); // Warp the player
	DynUpdateStart(playerid); // Avoid falling through object's
	return 1;}
public SetPlayerDMSpawn6(playerid){
	new rand = random(sizeof(DMRandomSpawns6));
	SetPlayerPos(playerid, DMRandomSpawns6[rand][0], DMRandomSpawns6[rand][1], DMRandomSpawns6[rand][2]); // Warp the player
	DynUpdateStart(playerid); // Avoid falling through object's
	return 1;}
public SetPlayerDMSpawn3(playerid){
	new rand = random(sizeof(DMRandomSpawns3));
	SetPlayerPos(playerid, DMRandomSpawns3[rand][0], DMRandomSpawns3[rand][1], DMRandomSpawns3[rand][2]); // Warp the player
	DynUpdateStart(playerid); // Avoid falling through object's
	return 1;}*/
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
if(!strcmp(cmdtext,"/help",true) || !strcmp(cmdtext, "/bangzhu",true))
{
...
//------------------------------------------------------------------------------
if(!strcmp(cmdtext,"/samp",true))
{
	SendFormatMessage(playerid, COLOR_HD, "参数设置");
	SendClientMessage(playerid, COLOR_BD, "    /textdraw /stuntbonus");
	...
	SendClientMessage(playerid, COLOR_FT, "← /help");
	return 1;
}
//------------------------------------------------------------------------------
if (!strcmp(cmdtext, "/commands", true) || !strcmp(cmdtext, "/cmds", true) || !strcmp(cmdtext, "/cmd", true) || !strcmp(cmdtext, "/mingling", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help                → /cmd help 1 /ml bz 1");
	return 1;
}
if (!strcmp(cmdtext, "/cmd help 1", true) || !strcmp(cmdtext, "/ml bz 1", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help                → /cmd help 2 /ml bz 2");
	return 1;
}
if (!strcmp(cmdtext, "/cmd help 2", true) || !strcmp(cmdtext, "/ml bz 2", true))
{
...
//------------------------------------------------------------------------------
if (!strcmp(cmdtext, "/gm", true) || !strcmp(cmdtext, "/guanli", true))
{
...
//------------------------------------------------------------------------------
if (!strcmp(cmdtext, "/my", true) || !strcmp(cmdtext, "/wo", true))
{
	SendFormatMessage(playerid, COLOR_HD, "全部命令");
	...
	SendFormatMessage(playerid, COLOR_HD, "/kill");
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /my help 1 /wo bz 1");
	return 1;
}
if (!strcmp(cmdtext, "/my help 1", true) || !strcmp(cmdtext, "/wo bz 1", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /my help 2 /wo bz 3");
	return 1;
}
if (!strcmp(cmdtext, "/my3", true) || !strcmp(cmdtext, "/wo3", true))
{
...
//------------------------------------------------------------------------------
if (!strcmp(cmdtext, "/parachute", true) || !strcmp(cmdtext, "/tiaosan", true))
{
	SendFormatMessage(playerid, COLOR_HD, "全部命令");
	SendClientMessage(playerid, COLOR_BD, "    /andromada /dive /basejump1 ~ /basejump9");
	SendFormatMessage(playerid, COLOR_HD, "/jls /para");
	SendClientMessage(playerid, COLOR_BD, "    随时随地获得降落伞");
	SendFormatMessage(playerid, COLOR_HD, "/andromada /fjts");
	SendClientMessage(playerid, COLOR_BD, "    飞机跳伞");
	SendFormatMessage(playerid, COLOR_HD, "/dive /ydts");
	SendClientMessage(playerid, COLOR_BD, "    原地高空跳伞");
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /parachute help 1 /ts bz 1");
	return 1;
}
if (!strcmp(cmdtext, "/parachute help 1", true) || !strcmp(cmdtext, "/ts bz 1", true))
{
...
//------------------------------------------------------------------------------
if (!strcmp(cmdtext, "/race", true) || !strcmp(cmdtext, "/saiche", true))
{
	SendFormatMessage(playerid, COLOR_HD, "全部命令");
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /race help 1 /sc bz 1");
	return 1;
}
if (!strcmp(cmdtext, "/race help 1", true) || !strcmp(cmdtext, "/sc bz 1", true))
{
...
//------------------------------------------------------------------------------
if (!strcmp(cmdtext, "/stunt", true) || !strcmp(cmdtext, "/teji", true))
{
	...
	SendClientMessage(playerid, COLOR_BD, "    /parkour1 ~ /parkour5 /bikepark /bikec");
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                ");
	return 1;
}
//------------------------------------------------------------------------------
	if(!strcmp(cmdtext,"/anim",true) || !strcmp(cmdtext,"/dongzuo",true))
	{
        SendFormatMessage(playerid, COLOR_HD, "动作");
		SendClientMessage(playerid, COLOR_BD, "    跳舞: /dance /animlist /animhelp /animhelp2 /animhelp3");
		SendClientMessage(playerid, COLOR_FT, "← /help                → /anim2");
		return 1;
	}
//------------------------------------------------------------------------------
if (!strcmp(cmdtext, "/dm", true) || !strcmp(cmdtext, "/pk", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /dm help 1 /dm bz 1");
	return 1;
}
if (!strcmp(cmdtext, "/dm help 1", true) || !strcmp(cmdtext, "/dm bz 1", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /dm help 2 /dm bz 2");
	return 1;
}
if (!strcmp(cmdtext, "/dm help 2", true) || !strcmp(cmdtext, "/dm bz 2", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /dm help 3 /dm bz 3");
	return 1;
}
if (!strcmp(cmdtext, "/dm help 3", true) || !strcmp(cmdtext, "/dm bz 3", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /dm help 4 /dm bz 4");
	return 1;
}
...
//------------------------------------------------------------------------------
if (!strcmp(cmdtext, "/car", true) || !strcmp(cmdtext, "/che", true) || !strcmp(cmdtext, "/feiji", true) || !strcmp(cmdtext, "/plane", true))
{
	SendFormatMessage(playerid, COLOR_HD, "全部命令");
	SendClientMessage(playerid, COLOR_BD, "    /carpark /v /vv /trans /arch /logo /bombshop /fix /fullfix /flip");
	SendClientMessage(playerid, COLOR_BD, "    /lock /unlock /cardive /vm /modnrg /carcolor /pimpedcars");
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /car help 1 /che bz 1");
	return 1;
}
if (!strcmp(cmdtext, "/car help 1", true) || !strcmp(cmdtext, "/che bz 1", true))
{
	SendFormatMessage(playerid, COLOR_HD, "/v /vmenu");
	SendClientMessage(playerid, COLOR_BD, "    收费菜单式买车");
	SendFormatMessage(playerid, COLOR_HD, "/vv /pimpedvehicles");
	SendClientMessage(playerid, COLOR_BD, "    花钱购买改装车");
	SendFormatMessage(playerid, COLOR_HD, "/trans /arch /loco");
	SendClientMessage(playerid, COLOR_BD, "    改车店");
	SendFormatMessage(playerid, COLOR_HD, "/bombshop");
	SendClientMessage(playerid, COLOR_BD, "    给车装一颗炸弹");
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /car help 2 /che bz 2");
	return 1;
}
if (!strcmp(cmdtext, "/car help 2", true) || !strcmp(cmdtext, "/che bz 2", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /car help 3 /che bz 3");
	return 1;
}
if (!strcmp(cmdtext, "/car help 3", true) || !strcmp(cmdtext, "/che bz 3", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /car help 4 /che bz 4");
	return 1;
}
if (!strcmp(cmdtext, "/car help 4", true) || !strcmp(cmdtext, "/che bz 4", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /car help 5 /che bz 5");
	return 1;
}
if (!strcmp(cmdtext, "/car help 5", true) || !strcmp(cmdtext, "/che bz 5", true))
{
	...
	SendClientMessage(playerid, COLOR_FT, "← /help /bangzhu                → /car help 6 /che bz 6");
	return 1;
}
...
//------------------------------------------------------------------------------
	if(strcmp(cmdtext,"/3q",true)==0 || strcmp(cmdtext,"/3ks",true)==0 || strcmp(cmdtext,"/tks",true)==0 || strcmp(cmdtext,"/thanks",true)==0)
	{
		...
		SendFormatMessage(playerid, COLOR_BD,"    Rafay,Zh3r0,vvg,yezizhu,CN_Shindo,Sean.X");
...
if (!strcmp(cmdtext, "/t", true) || !strcmp(cmdtext, "/tele", true) || !strcmp(cmdtext, "/teles", true) || !strcmp(cmdtext, "/teleports", true) || !strcmp(cmdtext, "/chuansong", true) || !strcmp(cmdtext, "/shunyi", true))
{
	...
	SendClientMessage(playerid, COLOR_BD, "    创建的传送命令,以 /v 开头,例如 /vmake lxd 就制作了一个 /vlxd 的传送命令");
...
//------------------------------------------------------------------------------
	if (!strcmp(cmdtext, "/tour", true) || !strcmp(cmdtext, "/lvyou", true) || !strcmp(cmdtext, "/ly", true) || !strcmp(cmdtext, "/travel", true))
	{
		...
		SendClientMessage(playerid, COLOR_FT, "← /help                → /tour2");
		return 1;
	}
...
//------------------------------------------------------------------------------
        if (strcmp(cmdtext, "/textdraw", true)==0)
        {
            if ( TDHS[playerid] == 0 )
            {
			   ...
			   SendFormatMessage(playerid, COLOR_ULTRARED, "[SA-MP] 特效文字 已开启, 再次输入 /textdraw 关闭");
			   GameTextForPlayer(playerid, "~y~TextDraws ~g~~h~Enabled",1200,5);
			   }else{
			   TDHS[playerid] = 0;
			   TextDrawHideForPlayer(playerid,Textdraw0);
			   TextDrawHideForPlayer(playerid,Textdraw1);
			   SendFormatMessage(playerid, COLOR_ULTRARED, "[SA-MP] 特效文字 已关闭, 再次输入 /textdraw 开启");
			   GameTextForPlayer(playerid, "~y~TextDraws ~r~~h~Disabled",1200,5);
               return 1;
            }
			return 1;
        }
...
//------------------------------------------------------------------------------
        /*if (!strcmp(cmdtext, "/explodeme", true) || !strcmp(cmdtext, "/bombme", true) | !strcmp(cmdtext, "", true))
		{
...
//------------------------------------------------------------------------------
        if(!strcmp(cmdtext, "/spos",true) || !strcmp(cmdtext,"/sp",true) || !strcmp(cmdtext,"/s",true))
		{
		if (IsPlayerInAnyVehicle(playerid))
		{
...
//------------------------------------------------------------------------------
        if(!strcmp(cmdtext, "/lp",true) || !strcmp(cmdtext,"/lpos",true) || !strcmp(cmdtext,"/l",true))
        {
...
//------------------------------------------------------------------------------
		if(strcmp(cmdtext, "/modnrg", true) == 0)
		{
			new Float:X, Float:Y, Float:Z;
			GetPlayerPos(playerid, X, Y, Z);
			if(GetPlayerMoney(playerid) >= 30000)
			{
				...
				mnrg[playerid] = CreateVehicle(522, X, Y, Z + 1, 90.0, -1, -1, -1);
				PutPlayerInVehicle(playerid, mnrg[playerid], 0);
				AddVehicleComponent(mnrg[playerid], 1079);
				SendFormatMessage(playerid, 0xFFFF00AA, "Modded NRG-500, bought for 30000$ !");
			}
			else if(GetPlayerMoney(playerid) < 60000)
			{
				SendFormatMessage(playerid, 0xEB000FFF, "ERROR: Not enought Moneys, 30000$ needed !");
			}
			return 1;
  }
//------------------------------------------------------------------------------
...
//========================[OTHERS]==============================================
	    ...
	    if(strcmp(cmdtext, "/parkour", true) == 0 || strcmp(cmdtext, "/parkour1", true) == 0 || strcmp(cmdtext, "/paoku 1", true) == 0)
	    {
...
return 1;}
//---------------------------------------------parkour2
if(strcmp(cmdtext,"/parkour 2",true)==0 || strcmp(cmdtext,"/paoku 2",true)==0){
SetPlayerInterior(playerid,0);{
...
//------------------------------------------------------------------------------
        if(!strcmp(cmd, "/vmenu",true) || !strcmp(cmd, "/v",true))
        {
         ShowMenuForPlayer(vmenu,playerid);
         TogglePlayerControllable(playerid, 0);
         return 1;
        }
//------------------------------------------------------------------------------
        if(!strcmp(cmd, "/pimpedvehicles",true) || !strcmp(cmd, "/vv",true))
        {
...
{
	Textdraw0 = TextDrawCreate(8.000000,429.000000,"Xtreme - Stunting");
	...
	Textdraw0 = TextDrawCreate(458.000000,433.000000," /commands /teles");
	TextDrawAlignment(Textdraw0,0);
	TextDrawBackgroundColor(Textdraw0,0x00000066);
	TextDrawFont(Textdraw0,3);
	TextDrawLetterSize(Textdraw0,0.499999,1.400000);
	...
	Uranus1 = AddStaticVehicle(558,350.2055,2459.4592,16.0787,267.4406,1,1); // Uranus1
	Elegy1 = AddStaticVehicle(562,346.6538,2467.8552,16.1432,357.1716,101,1); // Elegy1
	Sultan1 = AddStaticVehicle(560,361.1407,2466.6042,16.1885,358.9384,17,1); // Sultan1
	Uranus2 = AddStaticVehicle(558,360.1601,2458.9983,16.0735,267.3152,1,1); // Uranus2
	Elegy2 = AddStaticVehicle(562,337.1456,2467.9075,16.1377,353.3522,101,1); // Elegy2
	Sultan2 = AddStaticVehicle(560,361.1407,2466.6042,16.1885,358.9384,17,1); // Sultan2
	TuneCar();
	for(new i;i<MAX_PLAYERS;i++){
		Menu_Vehicle[i]=INVALID_VEHICLE_ID;
	}
...
public OnGameModeExit()
{
	...
	DestroyVehicle(Sultan1);
	DestroyVehicle(Sultan2);
	DestroyVehicle(Elegy1);
	DestroyVehicle(Elegy2);
	DestroyVehicle(Uranus1);
	DestroyVehicle(Uranus2);
   ...
   if(!strcmp(text, reactionstr, false))
    {
        if(reactioninprog == 2){// ReactionWin(playerid);
			...
			format(tempstring, sizeof(tempstring), "[游戏] 赢得了反应试验! **", reactionwinner);
...
public OnPlayerSelectedMenuRow(playerid, row)
{
    ...
    GetXYInFrontOfPlayer(playerid, Float:x, Float:y, 5.0);
    GetPlayerFacingAngle(playerid, Float:a);
//------------------------------------------------------------------------------
    if(CurrentMenu == TunedVehicles)
	{
		switch(row)
		{
	 case 0:
		    ...
		    TogglePlayerControllable(playerid, 0);
		    ShowMenuForPlayer(TunedVehicles,playerid);
	        SendClientMessage(playerid, 0x33AA33AA, "[错误] 您已经有车了.");
		    return 1;
		    }
		    else
		    {
	        ...
	        GivePlayerMoney(playerid, -14900);
 			PlayerVehI[playerid] = CreateVehicle(562, x, y, z + 2.0, a + 90.0, -1, -1, -1);
			...
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
			SendClientMessage(playerid, COLOR_YELLOW, "[交通] 购买了 Elegy 花费 14900");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
		    }
			}
			else
			{
			TogglePlayerControllable(playerid, 0);
			ShowMenuForPlayer(TunedVehicles,playerid);
			SendClientMessage(playerid, COLOR_ULTRARED, "[错误] 没有那么多钱! 您需要 14900$.");
			return 1;
			}}
	 case 1:
		    {
            ...
            TogglePlayerControllable(playerid, 1);
 			PlayerVehI[playerid] = CreateVehicle(560, x, y, z + 2.0, a + 90.0, -1, -1, -1);
			LinkVehicleToInterior(PlayerVehI[playerid], GetPlayerInterior(playerid));
			...
			ChangeVehiclePaintjob(PlayerVehI[playerid],random(2)+1);
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
			SendClientMessage(playerid, COLOR_YELLOW, "[交通] 购买了 Sultan 花费 16000$");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
		    }
			}
			...
			TogglePlayerControllable(playerid, 0);
			ShowMenuForPlayer(TunedVehicles,playerid);
			SendClientMessage(playerid, COLOR_ULTRARED, "[错误] 没有那么多钱! 您需要 16000$.");
			return 1;
			}}
	 case 2:
			{
            ...
            TogglePlayerControllable(playerid, 1);
			PlayerVehI[playerid] = CreateVehicle(567, x, y, z + 2.0, a + 90.0, -1, -1, -1);
			LinkVehicleToInterior(PlayerVehI[playerid], GetPlayerInterior(playerid));
			...
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
			SendClientMessage(playerid, COLOR_YELLOW, "[交通] 购买了 Savanna 花费 12000$");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
		    }
			}
			...
			TogglePlayerControllable(playerid, 0);
			ShowMenuForPlayer(TunedVehicles,playerid);
			SendClientMessage(playerid, COLOR_ULTRARED, "[错误] 没有那么多钱! 您需要 12000$.");
			return 1;
			}}
	 case 3:{
	        TogglePlayerControllable(playerid, 1);
            ...
            TogglePlayerControllable(playerid, 1);
	        PlayerVehI[playerid] = CreateVehicle(535, x, y, z + 2.0, a + 90.0, -1, -1, -1);
			LinkVehicleToInterior(PlayerVehI[playerid], GetPlayerInterior(playerid));
			...
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
   			SendClientMessage(playerid, COLOR_YELLOW, "[交通] 购买了 Slamvan 花费 14500$");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
		    }
			}
			...
			TogglePlayerControllable(playerid, 0);
			ShowMenuForPlayer(TunedVehicles,playerid);
			SendClientMessage(playerid, COLOR_ULTRARED, "[错误] 没有那么多钱! 您需要 14500$.");
			return 1;
			}}
	 case 4:{
	        TogglePlayerControllable(playerid, 1);
            if (GetPlayerMoney(playerid) >= 16800)
		    {
		    if(IsPlayerInAnyVehicle(playerid))
		    {
		    TogglePlayerControllable(playerid, 0);
		    ShowMenuForPlayer(TunedVehicles,playerid);
	        SendClientMessage(playerid, 0x33AA33AA, "[错误] 已经有车了.");
		    return 1;
		    }
		    else
		    {
		    GivePlayerMoney(playerid, -16800);
            TogglePlayerControllable(playerid, 1);
		    PlayerVehI[playerid] = CreateVehicle(559, x, y, z + 2.0, a + 90.0, -1, -1, -1);
			LinkVehicleToInterior(PlayerVehI[playerid], GetPlayerInterior(playerid));
		    ...
		    ChangeVehiclePaintjob(PlayerVehI[playerid],random(2)+1);
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
   			SendClientMessage(playerid, COLOR_YELLOW, "[交通] 购买了 Jester 花费 16800$");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
            }
			}
			...
			TogglePlayerControllable(playerid, 0);
			ShowMenuForPlayer(TunedVehicles,playerid);
			SendClientMessage(playerid, COLOR_ULTRARED, "[错误] 没有那么多钱! 您需要 16800$.");
			return 1;
			}}
	 case 5:{
	        TogglePlayerControllable(playerid, 1);
	        ...
	        TogglePlayerControllable(playerid, 1);
		    PlayerVehI[playerid] = CreateVehicle(565, x, y, z + 2.0, a + 90.0, -1, -1, -1);
			LinkVehicleToInterior(PlayerVehI[playerid], GetPlayerInterior(playerid));
        	ChangeVehiclePaintjob(PlayerVehI[playerid],random(2)+1);
			...
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
   			SendClientMessage(playerid, COLOR_YELLOW, "[交通] 您购买了 Flash 花费 18000$");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
		    }
			}
			...
			TogglePlayerControllable(playerid, 0);
			ShowMenuForPlayer(TunedVehicles,playerid);
			SendClientMessage(playerid, COLOR_ULTRARED, "[错误] 没有那么多钱! 您需要 18000$.");
			return 1;
			}}
	 case 6:{
	        TogglePlayerControllable(playerid, 1);
	        ...
	        TogglePlayerControllable(playerid, 1);
		    PlayerVehI[playerid] = CreateVehicle(534, x, y, z + 2.0, a + 90.0, -1, -1, -1);
			LinkVehicleToInterior(PlayerVehI[playerid], GetPlayerInterior(playerid));
        	ChangeVehiclePaintjob(PlayerVehI[playerid],2);
		    ...
		    AddVehicleComponent(PlayerVehI[playerid],1087);//HYDROLIK
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
   			SendClientMessage(playerid, COLOR_YELLOW, "[交通] 购买了 Remington 花费 10000$");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
		    }
			}
			...
			TogglePlayerControllable(playerid, 0);
			ShowMenuForPlayer(TunedVehicles,playerid);
			SendClientMessage(playerid, COLOR_ULTRARED, "[错误] 没有那么多钱! 您需要 10000$.");
			return 1;
			}}
     case 7:{
            TogglePlayerControllable(playerid, 1);
            if (GetPlayerMoney(playerid) >= 11200)
		    {
		    if(IsPlayerInAnyVehicle(playerid))
		    {
		    TogglePlayerControllable(playerid, 0);
		    ShowMenuForPlayer(TunedVehicles,playerid);
	        SendClientMessage(playerid, 0x33AA33AA, " 您已经有车了.");
		    return 1;
		    }
		    else
		    {
		    GivePlayerMoney(playerid, -11200);
            TogglePlayerControllable(playerid, 1);
  			PlayerVehI[playerid] = CreateVehicle(576, x, y, z + 2.0, a + 90.0, -1, -1, -1);
			LinkVehicleToInterior(PlayerVehI[playerid], GetPlayerInterior(playerid));
            ChangeVehiclePaintjob(PlayerVehI[playerid],random(2)+1);
			...
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
   			SendClientMessage(playerid, COLOR_YELLOW, "[交通] 购买了 Tornado 花费 11200$");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
		    }
			}
			...
			TogglePlayerControllable(playerid, 0);
			ShowMenuForPlayer(TunedVehicles,playerid);
			SendClientMessage(playerid, COLOR_ULTRARED, "[错误] 没有那么多钱! 您需要 11200$.");
			return 1;
			}}
     case 8:{
            TogglePlayerControllable(playerid, 1);
            ...
            TogglePlayerControllable(playerid, 1);
  			PlayerVehI[playerid] = CreateVehicle(561, x, y, z + 2.0, a + 90.0, -1, -1, -1);
			LinkVehicleToInterior(PlayerVehI[playerid], GetPlayerInterior(playerid));
		    ...
		    ChangeVehiclePaintjob(PlayerVehI[playerid],random(2)+1);
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
		  	SendClientMessage(playerid, COLOR_YELLOW, "[交通] 您购买了 Stratum 花费 20000$");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
		    }
			}
			...
			TogglePlayerControllable(playerid, 0);
			ShowMenuForPlayer(TunedVehicles,playerid);
			SendClientMessage(playerid, COLOR_ULTRARED, "[错误] 没有那么多钱! 您需要 20000$.");
			return 1;
			}}
	 case 9:{
	        TogglePlayerControllable(playerid, 1);
	        ...
	        TogglePlayerControllable(playerid, 1);
		    LinkVehicleToInterior(PlayerVehI[playerid], GetPlayerInterior(playerid));
		    PlayerVehI[playerid] = CreateVehicle(558, x, y, z + 2.0, a + 90.0, -1, -1, -1);
		    ...
		    ChangeVehiclePaintjob(PlayerVehI[playerid],random(2)+1);
			PutPlayerInVehicle(playerid,PlayerVehI[playerid],0);
   			SendClientMessage(playerid, COLOR_YELLOW, "[交通] 购买了 Uranus 花费 18000$");
			//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
			SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
		    }
			}
    ...
    if(CurrentMenu == vmenu)
	{
		switch(row)
		{
			case 0:
			{
				...
				if(IsPlayerInAnyVehicle(playerid))
				{
				ShowMenuForPlayer(vmenu,playerid);TogglePlayerControllable(playerid, 0);
				SendClientMessage(playerid, 0x33AA33AA, "[错误] 已经有车了");
				return 1;
				}
				else
				...
				vehicleid2=CreateVehicle(522,x+1,y+1,z+2,a,-1,-1,-1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				PutPlayerInVehicle(playerid, vehicleid2, 0);
				SendClientMessage(playerid, 0x33AA33AA, "[交通] 获取车辆成功");
				//SetTimerEx("TogglePlayerControllable",400,false,"i",playerid);
				SetTimerEx("Menu_DestroyVehicle",GetPlayerPing(playerid)*2,false,"i",playerid);
                }
				return 1;
            ...
            case 1:
			{
				...
				GetPlayerPos(playerid,x,y,z);
				GetPlayerFacingAngle(playerid,a);
				vehicleid2=CreateVehicle(468,x+1,y+1,z+2,a,-1,-1,-1);
								GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				PutPlayerInVehicle(playerid, vehicleid2, 0);
            ...
            case 2:
			{
				...
				GetPlayerPos(playerid,x,y,z);
				GetPlayerFacingAngle(playerid,a);
				vehicleid2=CreateVehicle(411,x+1,y+1,z+2,a,-1,-1,-1);
								GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				PutPlayerInVehicle(playerid, vehicleid2, 0);
            ...
            case 3:
			{
				...
				GetPlayerPos(playerid,x,y,z);
				GetPlayerFacingAngle(playerid,a);
				vehicleid2=CreateVehicle(451,x+1,y+1,z+2,a,-1,-1,-1);
								GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				PutPlayerInVehicle(playerid, vehicleid2, 0);
            ...
            case 4:
			{
				...
				GetPlayerPos(playerid,x,y,z);
				GetPlayerFacingAngle(playerid,a);
				vehicleid2=CreateVehicle(539,x+1,y+1,z+2,a,-1,-1,-1);
								GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				PutPlayerInVehicle(playerid, vehicleid2, 0);
		    ...
		    case 5:
			{
				...
				GetPlayerPos(playerid,x,y,z);
				GetPlayerFacingAngle(playerid,a);
				vehicleid2=CreateVehicle(487,x+1,y+1,z+2,a,-1,-1,-1);
								GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				PutPlayerInVehicle(playerid, vehicleid2, 0);
		    ...
		    case 6:
			{
				...
				GetPlayerPos(playerid,x,y,z);
				GetPlayerFacingAngle(playerid,a);
				vehicleid2=CreateVehicle(513,x+1,y+1,z+2,a,-1,-1,-1);
								GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
								GameTextForPlayer(playerid,"in",1,1);
			...
			case 7:
			{
				...
				GetPlayerPos(playerid,x,y,z);
				GetPlayerFacingAngle(playerid,a);
				vehicleid2=CreateVehicle(481,x+1,y+1,z+2,a,-1,-1,-1);
								GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				PutPlayerInVehicle(playerid, vehicleid2, 0);
			...
			case 8:
			{
				...
				GetPlayerPos(playerid,x,y,z);
				GetPlayerFacingAngle(playerid,a);
				vehicleid2=CreateVehicle(560,x+1,y+1,z+2,a,-1,-1,-1);
								GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				GameTextForPlayer(playerid,"in",1,1);
				PutPlayerInVehicle(playerid, vehicleid2, 0);
             ...
             case 9:
		        {
				 HideMenuForPlayer(vmenu,playerid);
				 TogglePlayerControllable(playerid,1);
		        }
		        }
		        }
...
{
	Menu_Vehicle[playerid]=INVALID_VEHICLE_ID;
	Menu_Vehicle_Count[playerid]=0;
	new string [MAX_STRING];
...
//-------------------------------[[PICKUPS]]------------------------------------
//------------------------------------------------------------------------------
    AddStaticPickup(1266, 1, 1529.096069, -1348.223632, 329.460937);//Funny!! on Big Tower
    AddStaticPickup(371,2,-2237.7300,-1711.5620,480.8730);//PARACHUTE
   	AddStaticPickup(371, 15, -2240.2351,-1747.3890,480.8622);//PARACHUTE
	AddStaticPickup(371, 15, 1545.5070,-1225.3750,261.5938);//PARACHUTE
	AddStaticPickup(371, 15, 1440.8297,-1227.1548,187.1926);//PARACHUTE
	AddStaticPickup(371, 15, 1498.3612,-1282.6539,113.7795);//PARACHUTE
	AddStaticPickup(371, 15, 1552.8856,-1264.9105,277.8750);//PARACHUTE
	AddStaticPickup(371, 15, 1548.4478,-1268.6362,261.5938);//PARACHUTE
	AddStaticPickup(371, 15, 1544.6133,-1272.7666,250.6563);//PARACHUTE
	AddStaticPickup(371, 15, 1656.8127,-1249.7767,233.3750);//PARACHUTE
	AddStaticPickup(371, 15, 1656.8175,-1274.2491,200.5234);//PARACHUTE
	AddStaticPickup(371, 15, 1661.2855,-1644.0159,87.3735);//PARACHUTE
...
//===================================[[MENUS]]==================================
//==============================================================================
	TunedVehicles = CreateMenu("Tuned Vehicles",2, 34.0, 170.0, 200.0);
	if(IsValidMenu(TunedVehicles))
    {
	AddMenuItem(TunedVehicles,0,"Elegy");
	AddMenuItem(TunedVehicles,0,"Sultan");
	AddMenuItem(TunedVehicles,0,"Savanna");
	AddMenuItem(TunedVehicles,0,"Slamvan");
	AddMenuItem(TunedVehicles,0,"Jester");
	AddMenuItem(TunedVehicles,0,"Flash");
	AddMenuItem(TunedVehicles,0,"Remington");
	AddMenuItem(TunedVehicles,0,"Tornado");
	AddMenuItem(TunedVehicles,0,"Stratum");
	AddMenuItem(TunedVehicles,0,"Uranus");
	AddMenuItem(TunedVehicles,0,"Exit");
    AddMenuItem(TunedVehicles,1,"~y~14900~g~$");
    AddMenuItem(TunedVehicles,1,"~y~16000~g~$");
    AddMenuItem(TunedVehicles,1,"~y~12000~g~$");
    AddMenuItem(TunedVehicles,1,"~y~14500~g~$");
    AddMenuItem(TunedVehicles,1,"~y~16800~g~$");
    AddMenuItem(TunedVehicles,1,"~y~18000~g~$");
    AddMenuItem(TunedVehicles,1,"~y~10000~g~$");
    AddMenuItem(TunedVehicles,1,"~y~11200~g~$");
    AddMenuItem(TunedVehicles,1,"~y~20000~g~$");
    AddMenuItem(TunedVehicles,1,"~y~18000~g~$");
    }
    
	vmenu = CreateMenu("Vehicles Menu", 1, 50.0, 180.0, 200.0, 200.0);
	if(IsValidMenu(vmenu))
    {
	AddMenuItem(vmenu,0,"NRG-500");
	AddMenuItem(vmenu,0,"Sanchez");
	AddMenuItem(vmenu,0,"Infernus");
	AddMenuItem(vmenu,0,"Turismo");
	AddMenuItem(vmenu,0,"Vortex");
	AddMenuItem(vmenu,0,"Maverick");
	AddMenuItem(vmenu,0,"Stuntplane");
	AddMenuItem(vmenu,0,"BMX");
	AddMenuItem(vmenu,0,"Sultan");
	AddMenuItem(vmenu,0,"Exit");
	}
}
	...
	public AutoRepair(playerid)
	{
		...
		PlayerPlaySound(playerid,1186 ,0, 0, 0);
 		...
 		//SendFormatMessage(playerid, COLOR_HD, "翻车啦?不要惊慌,试试 /filp /f ,交通工具会自动修复,不会爆炸.");
		}
	}
}
...
public Menu_DestroyVehicle(playerid){
	TogglePlayerControllable(playerid,1);
	//if(!Menu_Vehicle_Count[playerid]++)return;
	if(Menu_Vehicle[playerid] == INVALID_VEHICLE_ID){
		if(IsPlayerInAnyVehicle(playerid)){
			Menu_Vehicle[playerid] = GetPlayerVehicleID(playerid);
			printf("in vec id:%d",Menu_Vehicle[playerid]);
		}
		return;
	}else{
		SetVehicleToRespawn(Menu_Vehicle[playerid]);
		SetVehiclePos(Menu_Vehicle[playerid],0,0,500);
		DestroyVehicle(Menu_Vehicle[playerid]);
		Menu_Vehicle[playerid]=GetPlayerVehicleID(playerid);
		printf("de vec id:%d",Menu_Vehicle[playerid]);
		return;
	}
